...
public class Assets {
	...
	public static void init(){
		SpriteSheet sheetplayer = new SpriteSheet(ImageLoader.loadImage("/sprites/playersheet.png"));
		SpriteSheet sheettiles = new SpriteSheet(ImageLoader.loadImage("/sprites/tileset.png"));
